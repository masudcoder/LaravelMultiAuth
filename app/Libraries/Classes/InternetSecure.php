<?php
/**
 * @filename        InternetSecure.php
 * @description     This class is for doing transaction with InternetSecure.com's Authorize.Net emulator
 * @version         1.0
 ...
 * @license
 ***/
  class InternetSecure extends PaymentGateway
  {
      /**
      ...
      */
      ...
      function InternetSecure()
      {
          parent::PaymentGateway();
          $this->apiVersion = '3.1';
          $this->requestURL = 'https://anet.internetsecure.com/process.cgi';
          $this->testURL = 'https://anet.internetsecure.com/process.cgi';
          //$this->requestURL = 'https://secure.internetsecure.com/process.cgi';
          //$this->testURL = 'https://secure.internetsecure.com/process.cgi';
      ...
      */
      function initialize()
      {
          ...
          $this->setParam('x_tran_key', 'PWCEMU');
      ...
      */
      function setBillingInformation()
      {
          ...
          $this->setParam('x_address', $this->address1 . ' ' . $this->address2);
      ...
      */
      function validateBasicInput()
      {
          ...
          {
              $this->response->setError('InternetSecure login credentials have not been configured.');
          }
      }
