...
/**
 * @filename        PayPal.php
 * @description     This class is for making payment through PayPal Website Payment Pro
 * @version         1.0
 ...
 use App\Libraries\Classes\PaymentGateway;  
  class PayPal extends PaymentGateway
  {
      ...
      function createRecurringProfile()
      {
          ...
          if(!isset($this->customVariable1->value)) //If its not express checkout and token is empty
          {
              $this->validateCreditCardNumber();
              $this->validateExpiryDate();
          }
          ...
          if(isset($this->customVariable1->value) && $this->customVariable1->value)
          {
              $this->setParam('TOKEN', $this->customVariable1->value);
          }    
          $this->initialize();
          if(!isset($this->customVariable1->value)) //If its not express checkout and token is empty
             $this->setCardParameters();
      ...
      {
          $this->logMessage('Preparing request for getting recurring profile...');
      ...
      {
          $this->logMessage('Preparing request for getting Transaction Details...');
          ...
          $this->logMessage('Setting parameters...');
          $this->setParam('METHOD', 'GetTransactionDetails');
          $this->initialize();
          $this->setParam('TRANSACTIONID', $this->transactionId);
          $this->makeAPICall();
          return $this->response;
      ...
      */
      function validateBasicInput()
      {
          ...
          {
              $this->response->setError('PayPal login credentials have not been configured.');
          }
