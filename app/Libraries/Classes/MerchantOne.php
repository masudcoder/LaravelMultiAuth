<?php
/**
 * @filename        MerchantOne.php
 * @description     This class is for doing transaction with MerchantOne.com. This class is using MerchantOne's
 *                  Authorize.Net emulator to process transactions.
 * @version         1.0
 ...
 * @license
 ***/
  class MerchantOne extends PaymentGateway
  {
      /**
      ...
      */
      ...
      function MerchantOne()
      {
          parent::PaymentGateway();
          $this->apiVersion = '3.1';
          $this->requestURL = 'https://secure.nmi.com/gateway/transact.dll';
          $this->testURL = 'https://secure.nmi.com/gateway/transact.dll';
      ...
      */
      function validateBasicInput()
      {
          ...
          {
              $this->response->setError('MerchantOne.com login credentials have not been configured.');
          }
