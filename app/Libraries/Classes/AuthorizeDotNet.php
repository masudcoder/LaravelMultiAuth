<?php
/**
 * @filename        AuthorizeDotNet.php
 * @description     This class is for doing transaction with Authorize.net
 * @version         1.0
 ...
 ***/
 ...
 use App\Libraries\Classes\PaymentGateway;  
  class AuthorizeDotNet extends PaymentGateway
  {
      /**
      ...
      */
      ...
      function __construct()
      {
          parent::__construct();
          $this->apiVersion = '3.1';
          $this->requestURL = 'https://secure.authorize.net/gateway/transact.dll';                         
