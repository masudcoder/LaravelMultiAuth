 ...
 * @license
 ***/
  class EprocessingNetwork extends PaymentGateway
  {
      /**
      ...
      */
      ...
      function EprocessingNetwork()
      {
          ...
          $this->apiVersion = '3.1';
          $this->requestURL = 'https://www.eProcessingNetwork.Com/cgi-bin/an/transact.pl';
          $this->testURL = 'https://www.eProcessingNetwork.Com/cgi-bin/an/transact.pl';
      ...
      */
      function prepareResponse()
      {
          ...
          {
              $this->response->responseCode =  str_replace("'", '', $responseValues[0]);                    
